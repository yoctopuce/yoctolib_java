...
echo Build JAVA API
echo ==============
javac -d Binaries -sourcepath Sources Sources\com\yoctopuce\YoctoAPI\*.java || exit /b 1
cd Binaries
jar -cvf yoctoAPI.jar com\yoctopuce\YoctoAPI\*.class org\json\*.class || exit /b 1
IF "%1" == "" goto apidone
rd /s /q com
rd /s /q org
