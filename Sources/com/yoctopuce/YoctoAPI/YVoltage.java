/*********************************************************************
 *
 * $Id: YVoltage.java 11112 2013-04-16 14:51:20Z mvuilleu $
 *
 ...
 */
public class YVoltage extends YFunction
{
    //--- (definitions)
    private YVoltage.UpdateCallback _valueCallbackVoltage;
    /**
    ...
    {   YFunction yfunc = YAPI.getFunction("Voltage", func);
        if (yfunc != null) {
            return (YVoltage) yfunc;
        }
        return new YVoltage(func);
    }
    ...
    void advertiseValue(String newvalue)
    {
        ...
        if (_valueCallbackVoltage != null) {
            _valueCallbackVoltage.yNewValue(this, newvalue);
        }
    }
    ...
    {
        return super.hasCallbackRegistered() || (_valueCallbackVoltage!=null);
    }
