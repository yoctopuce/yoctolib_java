/*********************************************************************
 *
 * $Id: YHumidity.java 12324 2013-08-13 15:10:31Z mvuilleu $
 *
 ...
 */
public class YHumidity extends YFunction
{
    //--- (definitions)
    private YHumidity.UpdateCallback _valueCallbackHumidity;
    /**
    ...
    {   YFunction yfunc = YAPI.getFunction("Humidity", func);
        if (yfunc != null) {
            return (YHumidity) yfunc;
        }
        return new YHumidity(func);
    }
    ...
    void advertiseValue(String newvalue)
    {
        ...
        if (_valueCallbackHumidity != null) {
            _valueCallbackHumidity.yNewValue(this, newvalue);
        }
    }
    ...
    {
        return super.hasCallbackRegistered() || (_valueCallbackHumidity!=null);
    }
     ...
     * @noreturn
     */
    public void registerValueCallback(YHumidity.UpdateCallback callback)
    {
