...
public class DemoHTTPCallback extends HttpServlet
{
    ...
    private static final int NB_FEED_ITEM_TO_SHOW = 0;
    ...
    private void doRSSReader() throws YAPI_Exception
    {
        ...
        while (display != null) {
            ...
            for (RSSItem item : rssItems) {
                ...
                if ("Yocto-MaxiDisplay".equals(productname)) {
                    OutputMaxiDisplay(display, item);
                } else if ("Yocto-Display".equals(productname)) {
                    OutputMaxiDisplay(display, item);
                } else if ("Yocto-MiniDisplay".equals(productname)) {
